 ...
 */
async function getAuthToken(dbHost: string, dbPort: string, dbIamUser: string, awsRegion: string): Promise<string> {
 ...
 */
export async function createDbConnection(dbHost: string, dbPort: string, dbName: string, dbIamUser: string, awsRegion: string): Promise<Client> {
